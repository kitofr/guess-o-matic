...
var _kitofr$guess_o_matic$Port$playChar = _elm_lang$core$Native_Platform.outgoingPort(
	'playChar',
	function (v) {
		return v;
	});
var _kitofr$guess_o_matic$Port$correct = _elm_lang$core$Native_Platform.outgoingPort(
	'correct',
	function (v) {
		return v;
	});
...
var Elm = {};
Elm['Port'] = Elm['Port'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Port'], 'Port', typeof _kitofr$guess_o_matic$Port$main === 'undefined' ? null : _kitofr$guess_o_matic$Port$main);
