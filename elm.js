...
var _kitofr$guess_o_matic$Data$alternatives = _elm_lang$core$Native_List.fromArray(
	[
		...
		{word: 'HUND', image: 'http://4vector.com/i/free-vector-cartoon-dog-clip-art_128453_cartoon-dog-clip-art/Cartoon_Dog_clip_art_hight.png'},
		{word: 'LÄSA', image: 'http://4vector.com/i/free-vector-person-reading-book-clip-art_110276_Person_Reading_Book_clip_art_medium.png'},
		{word: 'KATT', image: 'http://4vector.com/i/free-vector-cartoon-cat-sitting-clip-art_118984_Cartoon_Cat_Sitting_clip_art_medium.png'},
		...
		{word: 'ÖDLA', image: 'http://4vector.com/i/free-vector-az-lizard-clip-art_127966_az-lizard-clip-art/Azlizard_clip_art_medium.png'},
		{word: 'ZEBRA', image: 'http://4vector.com/i/free-vector-studiofibonacci-cartoon-zebra-clip-art_118409_Studiofibonacci_Cartoon_Zebra_clip_art_medium.png'},
		...
		{word: 'GLASS', image: 'http://4vector.com/i/free-vector-soft-ice-cream-cones-ff-menu-clip-art_120791_soft-ice-cream-cones-ff-menu-clip-art/Soft_Ice_Cream_Cones_Ff_Menu_clip_art_medium.png'},
...
var _kitofr$guess_o_matic$Types$addGuess = F2(
	function (guess, state) {
		...
		var score$ = _kitofr$guess_o_matic$Types$points(guess) + score;
		var collected$ = A2(
		...
		if (_kitofr$guess_o_matic$Types$correct(guess)) {
			var _p12 = lst;
			if (_p12.ctor === '[]') {
				return A2(_kitofr$guess_o_matic$Types$FinishedGame, collected$, score$);
			} else {
				return A4(
					_kitofr$guess_o_matic$Types$Guessing,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$svg$Svg_Attributes$viewBox('0 0 200 200')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$fill('#EE9'),
						_elm_lang$svg$Svg_Attributes$points('100,10 40,198 190,78 10,78 160,198')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$fontSize('45'),
						_elm_lang$svg$Svg_Attributes$x(fontX),
						_elm_lang$svg$Svg_Attributes$y('130'),
...
var _kitofr$guess_o_matic$View$progress = function (_p2) {
	var _p3 = _p2;
	var total = 300.0;
	...
	var n = _elm_lang$core$Basics$toFloat(
		_elm_lang$core$List$length(
			_kitofr$guess_o_matic$Types$wordList(_p3.state)));
	var complete = ((tot - n) / tot) * total;
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$width(width),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$fill('#AAA'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$fill('#8C8'),
						_elm_lang$svg$Svg_Attributes$x('0'),
						_elm_lang$svg$Svg_Attributes$y('0'),
...
var _kitofr$guess_o_matic$View$answer = function (_p4) {
	var _p5 = _p4;
	return _kitofr$guess_o_matic$Types$word(_p5._1);
};
...
var _kitofr$guess_o_matic$View$hasMoreWords = function (_p6) {
	var _p7 = _p6;
	var lst = _kitofr$guess_o_matic$Types$wordList(_p7.state);
	var _p8 = lst;
	if (_p8.ctor === '[]') {
		return false;
	} else {
...
var _kitofr$guess_o_matic$View$currentAnswer = function (_p9) {
	var _p10 = _p9;
	var _p11 = _p10.guess;
	var question = _p11._1;
	return _kitofr$guess_o_matic$Types$word(question);
};
var _kitofr$guess_o_matic$View$image = function (_p12) {
	var _p13 = _p12;
	return _p13._1.image;
};
var _kitofr$guess_o_matic$View$picture = function (_p14) {
	var _p15 = _p14;
	return A2(
...
var _kitofr$guess_o_matic$View$rowDistance = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			...
			{ctor: '_Tuple2', _0: 'margin-top', _1: '25px'}
		]));
	...
	function (action, classes, what) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					classes,
					_kitofr$guess_o_matic$View$buttonStyle,
...
var _kitofr$guess_o_matic$View$disabledButton = function (ch) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn btn-disabled'),
				_kitofr$guess_o_matic$View$buttonStyle,
				_elm_lang$html$Html_Events$onClick(_kitofr$guess_o_matic$Types$Backspace)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
		...
		function (c) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn btn-disabled'),
						_kitofr$guess_o_matic$View$smallButtonStyle
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _kitofr$guess_o_matic$View$checkAnswer = function (_p16) {
	var _p17 = _p16;
	var _p19 = _p17.state;
	var _p18 = _p19;
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'margin-top', _1: '35px'}
							]))
					]),
				_kitofr$guess_o_matic$View$collectedChars(_p18._0))
			]);
	} else {
		return _kitofr$guess_o_matic$Types$correct(_p17.guess) ? _elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_kitofr$guess_o_matic$View$megaButton,
						_elm_lang$html$Html_Events$onClick(
						_kitofr$guess_o_matic$Types$NewWord(_p19))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-thumbs-up')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
...
var _kitofr$guess_o_matic$View$row = _elm_lang$html$Html$div(
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_kitofr$guess_o_matic$View$rowDistance
		]));
	...
	return _kitofr$guess_o_matic$View$row(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_kitofr$guess_o_matic$View$controlButton, _kitofr$guess_o_matic$Types$Reset, 'glyphicon-refresh'),
						A2(_kitofr$guess_o_matic$View$controlButton, _kitofr$guess_o_matic$Types$Backspace, 'glyphicon-erase')
					]))
			]));
};
var _kitofr$guess_o_matic$View$showGuess = function (_p20) {
	var _p21 = _p20;
	var _p22 = _p21.guess;
	var answer$ = _elm_lang$core$String$toList(
		_kitofr$guess_o_matic$View$answer(_p22));
	var paddTo = _elm_lang$core$List$length(answer$);
	var paddedGuess = A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_kitofr$guess_o_matic$View$stylesheet('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_kitofr$guess_o_matic$View$container_(
						_elm_lang$core$Native_List.fromArray(
							[
								_kitofr$guess_o_matic$View$row(
								_elm_lang$core$Native_List.fromArray(
									[
										_kitofr$guess_o_matic$View$picture(model),
										A2(
										_elm_lang$html$Html$div,
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_kitofr$guess_o_matic$View$score(model),
												_kitofr$guess_o_matic$View$success(model)
											]))
									])),
								_kitofr$guess_o_matic$View$progress(model),
								_kitofr$guess_o_matic$View$textControls(model),
								_kitofr$guess_o_matic$View$showGuess(model),
								_kitofr$guess_o_matic$View$letterButtons(model),
								_kitofr$guess_o_matic$View$soundButtons(model)
							]))
					]))
			]));
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _kitofr$guess_o_matic$Main$main === 'undefined' ? null : _kitofr$guess_o_matic$Main$main);
